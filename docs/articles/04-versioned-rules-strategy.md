...
*Part 4 of 5 — Domain-Driven Design, learned from a real loyalty-program backend.*
...
base, [`BaseRule`](../../src/Loyalty.Core.Entities/Rules/ICompatibleRule.cs):
...
And the concrete strategies ([`StampsRuleV1`](../../src/Loyalty.Core.Entities/Rules/StampsRuleV1.cs),
[`PercentFixedRuleV1`](../../src/Loyalty.Core.Entities/Rules/PercentFixedRuleV1.cs),
[`PercentThatDependsOnTotalSumRuleV1`](../../src/Loyalty.Core.Entities/Rules/PercentThatDependsOnTotalSumRuleV1.cs)):
...
[`LoyaltyRuleType`](../../common/Loyalty.Shared.Contracts/Enums/LoyaltyRuleType.cs) — and it's a `[Flags]`
...
[`LoyaltyGroupRule`](../../src/Loyalty.Core.Entities/Aggregates/LoyaltyPrograms/LoyaltyGroupRule.cs):
...
[`LoyaltyRuleVersion`](../../common/Loyalty.Shared.Contracts/Enums/LoyaltyRuleVersion.cs) enum:
...
live in [`Core.Entities/Rules`](../../src/Loyalty.Core.Entities/Rules) and the storage value object in
[`LoyaltyGroupRule`](../../src/Loyalty.Core.Entities/Aggregates/LoyaltyPrograms/LoyaltyGroupRule.cs).*
