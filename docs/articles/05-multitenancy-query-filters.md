# Multi-Tenancy in EF Core: One Database, Many Venues, Zero Leaks

*Part 5 of 5 — Domain-Driven Design, learned from a real loyalty-program backend.*
...
inherit [`TenantEntity`](../../src/Loyalty.Core.Entities/Base/TenantEntity.cs), which forces each to
...
an abstraction, [`ITenantProvider`](../../src/Loyalty.Core.Contracts/ITenantProvider.cs):
...
([`TenantTokenProvider`](../../src/Loyalty.Infrastructure.DataAccess/TenantTokenProvider.cs)):
...
tenant-aware context ([`LoyaltyTenantDbContext`](../../src/Loyalty.Infrastructure.DataAccess/Context/LoyaltyTenantDbContext.cs))
...
every save ([`AddAuditInfo`](../../src/Loyalty.Infrastructure.DataAccess/Context/LoyaltyTenantDbContext.cs)):
...
is [`LoyaltyTenantDbContext`](../../src/Loyalty.Infrastructure.DataAccess/Context/LoyaltyTenantDbContext.cs);
the tenant resolver is [`TenantTokenProvider`](../../src/Loyalty.Infrastructure.DataAccess/TenantTokenProvider.cs).*
