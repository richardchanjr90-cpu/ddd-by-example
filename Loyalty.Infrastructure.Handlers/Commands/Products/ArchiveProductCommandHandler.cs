...
namespace Loyalty.Infrastructure.Handlers.Commands.Products
{
    ...
    {
        public ArchiveProductCommandHandler(ILoyaltyDbContext context) : base(context)
        {
        }

        public Task<ICommandResult> Handle(ArchiveProductCommand request, CancellationToken cancellationToken)
        {
