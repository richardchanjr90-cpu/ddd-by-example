...
{
    public class ProductPostFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly ProductAppService service;

        public ProductPostFunction(ProductAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
