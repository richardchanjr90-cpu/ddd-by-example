...
{
    public class ProductPatchFunction
    {
        private readonly ProductAppService service;

        public ProductPatchFunction(ProductAppService service)
        {
        ...
        public async Task<IActionResult> Run(
            long groupId,
            [HttpTrigger(AuthorizationLevel.Function, "patch", Route = "productGroups/{groupId}/products")]
            ...
            ILogger log)
        {
            ...
            {
                return new OkObjectResult(await service.Patch(model, groupId));
            });
        }
    }
}