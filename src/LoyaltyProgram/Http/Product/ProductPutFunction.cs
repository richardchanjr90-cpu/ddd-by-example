...
{
    public class ProductPutFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly ProductAppService service;

        public ProductPutFunction(ProductAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
