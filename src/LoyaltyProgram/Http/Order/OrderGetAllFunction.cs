...
{
    public class OrderGetAllFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly OrderAppService service;

        public OrderGetAllFunction(OrderAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
