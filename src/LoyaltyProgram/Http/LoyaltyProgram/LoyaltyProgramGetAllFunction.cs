...
{
    public class LoyaltyProgramGetAllFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly LoyaltyProgramAppService service;

        public LoyaltyProgramGetAllFunction(LoyaltyProgramAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
