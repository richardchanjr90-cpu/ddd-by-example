...
namespace LoyaltyProgram.Http.Write.Purchase
{
    public class PurchaseBurnPutFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly PurchaseAppService service;

        public PurchaseBurnPutFunction(PurchaseAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
