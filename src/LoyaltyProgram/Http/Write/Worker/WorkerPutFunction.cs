...
{
    public class WorkerPutFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly WorkerAppService service;

        public WorkerPutFunction(WorkerAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
