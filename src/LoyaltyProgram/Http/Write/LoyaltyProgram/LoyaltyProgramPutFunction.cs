...
namespace LoyaltyProgram.Http.Write.LoyaltyProgram
{
    public class LoyaltyProgramPutFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly LoyaltyProgramAppService service;

        public LoyaltyProgramPutFunction(LoyaltyProgramAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
