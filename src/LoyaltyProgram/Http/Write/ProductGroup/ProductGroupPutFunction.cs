...
{
    public class ProductGroupPutFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly ProductGroupAppService service;

        public ProductGroupPutFunction(ProductGroupAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
