...
{
    public class LoyaltyProductGroupDeleteFunction : DisposeContextFilter<ILoyaltyTenantDbContext>
    {
        private readonly LoyaltyProductGroupAppService service;

        public LoyaltyProductGroupDeleteFunction(LoyaltyProductGroupAppService service, ILoyaltyTenantDbContext context) 
            : base(context)
        {
