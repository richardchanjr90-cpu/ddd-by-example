namespace Loyalty.Common.Shared.Settings
{
    public class ImageSettings
    {
        ...
        public int MaxLogoImageHeight { get; set; } = 1200;
        public int MaxLogoImageWidth { get; set; } = 1200;
        public int MinLogoImageHeight { get; set; } = 400;
        public int MinLogoImageWidth { get; set; } = 400;

        public int MaxProductImageHeight { get; set; } = 1200;
        public int MaxProductImageWidth { get; set; } = 1200;
        public int MinProductImageHeight { get; set; } = 400;
        public int MinProductImageWidth { get; set; } = 400;
    }
}