...
namespace Loyalty.Application.ViewModels.Venue
{
    public class VenueViewModel
    {
        ...
        [JsonProperty("fullDescription")] public string FullDescription { get; set; }

        [JsonProperty("phones")] public List<string> Phones { get; set; }

        [JsonProperty("webSites")] public List<string> WebSites { get; set; }

        [JsonProperty("workingHours")] public List<WorkingHoursViewModel> WorkingHours { get; set; }

        [JsonProperty("parentId")] public long? ParentId { get; set; }

        [JsonProperty("location")] public LocationViewModel Location { get; set; }

        [JsonProperty("type")] public int Type { get; set; }

        [JsonProperty("categoryType")] public int CategoryType { get; set; }

        [JsonProperty("logoUrl")] public string LogoUrl { get; set; }

        [JsonProperty("isArchived")] public bool IsArchived { get; set; }

        [JsonProperty("isPublished")] public bool IsPublished { get; set; }
