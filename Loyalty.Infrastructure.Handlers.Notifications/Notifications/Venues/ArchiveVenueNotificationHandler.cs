...
{
    public class ArchiveVenueNotificationHandler : BaseNotificationHandler, IArchiveVenueNotificationHandler
    {
        private readonly IQueueClient client;

        public ArchiveVenueNotificationHandler(IQueueClient client) : base(client)
        {
            this.client = client;
        }

        public async Task Handle(ArchiveVenueNotification notification, CancellationToken cancellationToken)
        {
